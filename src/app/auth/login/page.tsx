...
export default function LoginPage() {
  ...
  return (
    <div className="auth-container">
      {/* Glows */}
      <div className="auth-glow" style={{ top: '-20%', left: '-10%', width: 500, height: 500, background: 'radial-gradient(circle, rgba(74,124,89,0.15) 0%, transparent 70%)' }} />
      <div className="auth-glow" style={{ bottom: '-15%', right: '-10%', width: 400, height: 400, background: 'radial-gradient(circle, rgba(107,163,190,0.1) 0%, transparent 70%)' }} />
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <p style={{ color: 'var(--text-secondary)', marginTop: 8, fontSize: 14 }}>Welcome back. Your journey continues.</p>
        </div>

        {/* Card */}
        <div className="card" style={{ padding: '36px 32px' }}>
          <h1 style={{ fontSize: 22, fontWeight: 700, marginBottom: 24, color: 'var(--text-primary)' }}>Sign in</h1>

          {/* Google OAuth */}
          <button
            onClick={handleGoogleLogin}
            className="btn-ghost"
            style={{ width: '100%', marginBottom: 20, justifyContent: 'center', gap: 10, padding: '13px 0' }}
          >
          ...
          <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input {...register('email')} type="email" id="email" placeholder="you@example.com" className="input-field" style={{ paddingLeft: 44 }} />
              </div>
        ...
        <p style={{ textAlign: 'center', marginTop: 20, color: 'var(--text-muted)', fontSize: 14 }}>
          New here?{' '}
          <Link href="/auth/register" style={{ color: 'var(--sage-300)', fontWeight: 600, textDecoration: 'none' }}>
            Create your account
          </Link>
        </p>
      </motion.div>
